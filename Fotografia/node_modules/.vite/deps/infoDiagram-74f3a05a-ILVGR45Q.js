...
// node_modules/mermaid/dist/infoDiagram-74f3a05a.js
var O = function() {
    ...
    parse: function(t) {
      ...
      for (var l, g, h, w, _ = {}, b, c, F, S; ; ) {
        if (g = n[n.length - 1], this.defaultActions[g] ? h = this.defaultActions[g] : ((l === null || typeof l > "u") && (l = U()), h = d[g] && d[g][l]), typeof h > "u" || !h.length || !h[0]) {
          ...
          o.showPosition ? A2 = "Parse error on line " + (v + 1) + `:
` + o.showPosition() + `
Expecting ` + S.join(", ") + ", got '" + (this.terminals_[l] || l) + "'" : A2 = "Parse error on line " + (v + 1) + ": Unexpected " + (l == T ? "end of input" : "'" + (this.terminals_[l] || l) + "'"), this.parseError(A2, {
            text: o.match,
...
` + a);
  const k = D_(f);
  wl(k, 100, 400, true), k.append("g").append("text").attr("x", 100).attr("y", 40).attr("class", "version").attr("font-size", 32).style("text-anchor", "middle").text(`v${m}`);
};
var H = { draw: G };
var K = {
  parser: B,
...
//# sourceMappingURL=infoDiagram-74f3a05a-ILVGR45Q.js.map
