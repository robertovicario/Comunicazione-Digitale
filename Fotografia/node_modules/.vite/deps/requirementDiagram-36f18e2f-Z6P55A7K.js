...
// node_modules/mermaid/dist/requirementDiagram-36f18e2f.js
var ce = function() {
  var e = function(V, i, r, a) {
    for (r = r || {}, a = V.length; a--; r[V[a]] = i)
      ;
    return r;
  }, t = [1, 3], l = [1, 4], c = [1, 5], u = [1, 6], d = [5, 6, 8, 9, 11, 13, 31, 32, 33, 34, 35, 36, 44, 62, 63], f = [1, 18], h = [2, 7], o = [1, 22], E = [1, 23], R = [1, 24], A2 = [1, 25], T = [1, 26], N = [1, 27], w = [1, 20], k = [1, 28], x = [1, 29], F = [62, 63], de = [5, 8, 9, 11, 13, 31, 32, 33, 34, 35, 36, 44, 51, 53, 62, 63], fe = [1, 47], pe = [1, 48], ye = [1, 49], _e = [1, 50], Ee = [1, 51], ge = [1, 52], Re = [1, 53], O = [53, 54], M = [1, 64], D = [1, 60], P2 = [1, 61], Y = [1, 62], U = [1, 63], B = [1, 65], j = [1, 69], z = [1, 70], X = [1, 67], J = [1, 68], m = [5, 8, 9, 11, 13, 31, 32, 33, 34, 35, 36, 44, 62, 63], ie = {
    trace: function() {
    },
    yy: {},
...
var it = (e) => (G[e] === void 0 && (G[e] = {
  ...
  type: q.type,
  docRef: q.docRef
}, A.info("Added new requirement: ", e)), q = {}, G[e]);
var nt = () => G;
var rt = (e) => {
  q !== void 0 && (q.type = e);
};
...
var yt = (e, t, l) => {
  Object.keys(e).forEach((c) => {
    let u = e[c];
    c = H(c), A.info("Added new requirement: ", c);
...
var Rt = (e, t, l, c) => {
  ...
  let E = c.db.getRequirements(), R = c.db.getElements(), A2 = c.db.getRelationships();
  yt(E, o, h), _t(R, o, h), Et(A2, o), js(o), gt(h, o), A2.forEach(function(x) {
    pt(h, x, o, t, c);
  });
  const T = y.rect_padding, N = h.node().getBBox(), w = N.width + T * 2, k = N.height + T * 2;
  wl(h, k, w, y.useMaxWidth), h.attr("viewBox", `${N.x - T} ${N.y - T} ${w} ${k}`);
};
var mt = {
  draw: Rt
};
...
//# sourceMappingURL=requirementDiagram-36f18e2f-Z6P55A7K.js.map
