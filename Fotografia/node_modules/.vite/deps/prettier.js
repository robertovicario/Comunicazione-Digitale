...
var require_standalone = __commonJS({
  "node_modules/prettier/standalone.js"(exports, module) {
    (function(t) {
      ...
      var Ce = (t, e, r) => (r = t != null ? au(lu(t)) : {}, rr(e || !t || !t.__esModule ? $e(r, "default", { value: t, enumerable: true }) : r, t)), nr = (t) => rr($e({}, "__esModule", { value: true }), t);
      var du = (t, e, r) => {
        if (!e.has(t))
        ...
        ur.prototype = { diff: function(e, r) {
          ...
          function d() {
            for (var p = -1 * D; p <= D; p += 2) {
              ...
              if (!C || _ && E.newPos < h.newPos ? (m = Eu(h), u.pushComponent(m.components, void 0, true)) : (m = E, m.newPos++, u.pushComponent(m.components, true, void 0)), g = u.extractCommon(m, r, e, p), m.newPos + 1 >= s && g + 1 >= a)
 ...
 `, i(u.gutter, g.replace(/\d/g, " ")), " ", $, i(u.marker, "^").repeat(Q)].join(""), _ && r.message && (Z += " " + i(u.message, r.message));
              ...
              return [i(u.marker, ">"), i(u.gutter, g), p.length > 0 ? ` ${p}` : "", Z].join("");
            } else
...
${l}`), n ? o.reset(l) : l;
      ...
      var Qo = {};
      Me(Qo, { __debug: () => Zo, check: () => Jo, doc: () => er, format: () => su, formatWithCursor: () => iu, getSupportInfo: () => Xo, util: () => Qt, version: () => ou });
      var Fu = (t, e, r, n) => {
        if (!(t && e == null))
          return e.replaceAll ? e.replaceAll(r, n) : r.global ? e.replace(r, n) : e.split(r).join(n);
      }, ee = Fu;
      var Wn = Ce(ir(), 1);
      var U = "string", j = "array", M = "cursor", T = "indent", S = "align", v = "trim", A = "group", k = "fill", B = "if-break", P = "indent-if-break", L = "line-suffix", I = "line-suffix-boundary", x = "line", O = "label", b = "break-parent", We = /* @__PURE__ */ new Set([M, T, S, v, A, k, B, P, L, I, x, O, b]);
      function yu(t) {
        if (typeof t == "string")
          return U;
        if (Array.isArray(t))
...
Expected it to be ${n}.`;
      ...
      function xt(t, e = {}) {
        return z(t), ze(e.expandedStates, true), { type: A, id: e.id, contents: t, break: !!e.shouldBreak, expandedStates: e.expandedStates };
      }
      function Dr(t) {
      ...
      function pr(t, e = "", r = {}) {
        return z(t), e !== "" && z(e), { type: B, breakContents: t, flatContents: e, groupId: r.groupId };
      }
      function dr(t, e) {
      ...
      var Fr = { type: I }, le = { type: b }, mr = { type: v }, Ae = { type: x, hard: true }, _t = { type: x, hard: true, literal: true }, Ke = { type: x }, Er = { type: x, soft: true }, G = [Ae, le], He = [_t, le], Be = { type: M };
      function ke(t, e) {
        z(t), ze(e);
        let r = [];
...
`);
      ...
      function Oe(t) {
        switch (W(t)) {
          ...
          case B:
            return { ...t, breakContents: Oe(t.breakContents), flatContents: Oe(t.flatContents) };
          case k:
...
`)) : r);
      ...
      function Pu(t, e, r) {
        return e === Number.NEGATIVE_INFINITY ? t.root || Tr() : e < 0 ? Bt(t, { type: "dedent" }, r) : e ? e.type === "root" ? { ...t, root: t } : Bt(t, { type: typeof e == "string" ? "stringAlign" : "numberAlign", n: e }, r) : t;
      }
      function Bt(t, e, r) {
      ...
      function fe(t, e) {
        let r = {}, n = e.printWidth, o = be(e.endOfLine), u = 0, i = [{ ind: Tr(), mode: R, doc: t }], s = [], a = false, D = [], c = 0;
        for (br(t); i.length > 0; ) {
...
`, o) : l;
            ...
            case k: {
              ...
              if (m.length === 0)
                break;
              let [E, h] = m, g = { ind: f, mode: K, doc: E }, C = { ind: f, mode: R, doc: E }, _ = Qe(g, [], p, D.length > 0, r, true);
              if (m.length === 1) {
                _ ? i.push(g) : i.push(C);
                break;
              }
              ...
              m.splice(0, 2);
              let Q = { ind: f, mode: d, doc: Ge(m) }, tr = m[0];
              Qe({ ind: f, mode: K, doc: [E, h, tr] }, [], p, D.length > 0, r, true) ? i.push(Q, Z, g) : _ ? i.push(Q, $, g) : i.push(Q, $, C);
              break;
            }
            case B:
            case P: {
...
in order for it to be formatted.`, cliCategory: "Other" }, tabWidth: { type: "int", category: "Global", default: 2, description: "Number of spaces per indentation level.", range: { start: 0, end: 1 / 0, step: 1 } }, useTabs: { category: "Global", type: "boolean", default: false, description: "Indent with tabs instead of spaces." }, embeddedLanguageFormatting: { category: "Global", type: "choice", default: "auto", description: "Control how Prettier formats quoted code embedded in the file.", choices: [{ value: "auto", description: "Format embedded code if Prettier can automatically identify it." }, { value: "off", description: "Never automatically format embedded code." }] } };
      function et({ plugins: t = [], showDeprecated: e = false } = {}) {
        ...
        for (let o of Ru(Object.assign({}, ...t.map(({ options: u }) => u), vr)))
          !e && o.deprecated || (Array.isArray(o.choices) && (e || (o.choices = o.choices.filter((u) => !u.deprecated)), o.name === "parser" && (o.choices = [...o.choices, ...Iu(o.choices, r, t)])), o.pluginDefaults = Object.fromEntries(t.filter((u) => {
            var i;
      ...
      var bt = Ce(Pe(), 1), Yr = (t, e, { descriptor: r }) => {
        let n = [`${bt.default.yellow(typeof t == "string" ? r.key(t) : r.pair(t))} is deprecated`];
...
`)), Mr(u, r.loggerPrintWidth);
      ...
      function Vr(t, e, r, n) {
        return [`Invalid ${se.default.red(n.key(t))} value.`, `Expected ${se.default.blue(r)},`, `but received ${e === tt ? se.default.gray("nothing") : se.default.red(n.value(e))}.`].join(" ");
      }
      function Ur({ text: t, list: e }, r) {
        let n = [];
        return t && n.push(`- ${se.default.blue(t)}`), e && n.push([`- ${se.default.blue(e.title)}:`].concat(e.values.map((o) => Ur(o, r - jr.length).replace(/^|\n/g, `$&${jr}`))).join(`
`)), Mr(n, r);
      }
      function Mr(t, e) {
        if (t.length === 1)
...
`, 1)[0].length);
      ...
      var rt = (t, e, { descriptor: r, logger: n, schemas: o }) => {
        let u = [`Ignored unknown option ${Nt.default.yellow(r.pair({ key: t, value: e }))}.`], i = Object.keys(o).sort().find((s) => Ot(t, s) < 3);
        i && u.push(`Did you mean ${Nt.default.blue(r.key(i))}?`), n.warn(u.join(" "));
      };
      var $u = ["default", "expected", "validate", "deprecated", "forward", "redirect", "overlap", "preprocess", "postprocess"];
      function Uu(t, e) {
        let r = new t(e), n = Object.create(r);
        for (let o of $u)
          o in e && (n[o] = Mu(e[o], r, w.prototype[o].length));
        return n;
      }
      var w = class {
        static create(e) {
      ...
      function St(t) {
        if (typeof t == "string")
          return { text: t };
        let { text: e, list: r } = t;
        return Wu((e || r) !== void 0, "Unexpected `expected` result, there should be at least one field."), r ? { text: e, list: { title: r.title, values: r.values.map(St) } } : { text: e };
      }
      function vt(t, e) {
        return t === true ? true : t === false ? { value: e } : t;
      }
      function Pt(t, e, r = false) {
        ...
        _applyNormalization(e, r) {
          ...
          for (let i of o) {
            ...
            let D = ({ from: d, to: l }) => {
              ...
              let p = Pt(s.deprecated(d, this._utils), a, true);
              if (p !== false)
                if (p === true)
      ...
      var It;
      function Gu(t, e, { logger: r = false, isCLI: n = false, passThrough: o = false, FlagSchema: u, descriptor: i } = {}) {
        if (n) {
          if (!u)
        ...
        }, a = Ku(e, { isCLI: n, FlagSchema: u }), D = new lt(a, { logger: r, unknown: s, descriptor: i }), c = r !== false;
      ...
      function Ku(t, { isCLI: e, FlagSchema: r }) {
        ...
        for (let o of t)
          n.push(Hu(o, { isCLI: e, optionInfos: t, FlagSchema: r })), o.alias && e && n.push(nt.create({ name: o.alias, sourceName: o.name }));
        return n;
      }
      ...
      var re = qu;
      var Dn = /* @__PURE__ */ new Set(["tokens", "comments", "parent", "enclosingNode", "precedingNode", "followingNode"]), Ju = (t) => Object.keys(t).filter((e) => !Dn.has(e));
      function Xu(t) {
...
` || o === "\r" || o === "\u2028" || o === "\u2029")
      ...
      function Wt(t, e) {
        (t.comments ?? (t.comments = [])).push(e), e.printed = false, e.nodeDescription = fo(t);
      }
      function ne(t, e) {
      ...
      function Et(t, e) {
        ...
        if (!n)
          return [];
        let s = ((r == null ? void 0 : r(t, e)) ?? [...Mt(t, { getVisitorKeys: H(o) })]).flatMap((a) => n(a) ? [a] : Et(a, e));
      ...
      function bn(t, e) {
        ...
        if (delete t.comments, !Ut(r) || !e.printer.canAttachComment)
          return;
        let n = [], { locStart: o, locEnd: u, printer: { experimentalFeatures: { avoidAstMutation: i = false } = {}, handleComments: s = {} }, originalText: a } = e, { ownLine: D = Gt, endOfLine: c = Gt, remaining: F = Gt } = s, f = r.map((d, l) => ({ ...kn(t, d, e), comment: d, text: a, options: e, ast: t, isLastComment: r.length - 1 === l }));
        for (let [d, l] of f.entries()) {
          ...
          let $;
          if (i ? $ = [l] : (p.enclosingNode = E, p.precedingNode = m, p.followingNode = h, $ = [p, g, C, _, Z]), po(g, C, f, d))
            p.placement = "ownLine", D(...$) || (h ? ne(h, p) : m ? ue(m, p) : E ? X(E, p) : X(_, p));
          else if (Fo(g, C, f, d))
            p.placement = "endOfLine", c(...$) || (m ? ue(m, p) : h ? ne(h, p) : E ? X(E, p) : X(_, p));
          else if (p.placement = "remaining", !F(...$))
            if (m && h) {
              let Q = n.length;
              Q > 0 && n[Q - 1].followingNode !== h && Bn(n, C), n.push(l);
            } else
              m ? ue(m, p) : h ? ne(h, p) : E ? X(E, p) : X(_, p);
        }
        if (Bn(n, e), !i)
          for (let d of r)
      ...
      function mo(t, e) {
        let r = e - 1;
        r = N(t, r, { backwards: true }), r = Y(t, r, { backwards: true }), r = N(t, r, { backwards: true });
        let n = Y(t, r, { backwards: true });
        return r !== n;
      }
      var Ye = mo;
      function On(t, e) {
      ...
      function Eo(t, e) {
        var c;
        let r = t.node, n = [On(t, e)], { printer: o, originalText: u, locStart: i, locEnd: s } = e;
      ...
      async function go(t, e, r, n) {
        let o = await re({ ...r, ...e, parentParser: r.parser, originalText: t }, { passThrough: true }), { ast: u } = await ae(t, o), i = await n(u, o);
        return Xe(i);
      }
      function yo(t) {
        return () => {
      ...
      async function je(t, e) {
        ({ ast: t } = await Ht(t, e));
        let r = /* @__PURE__ */ new Map(), n = new gn(t), o = vn(e), u = /* @__PURE__ */ new Map();
        await Sn(n, s, e, je, u);
      ...
      function Ln(t, e, r, n, o) {
        ...
        return (a = i.hasPrettierIgnore) != null && a.call(i, t) ? s = Pn(t, e) : o.has(u) ? s = o.get(u) : s = i.print(t, e, r, n), u === e.cursorNode && (s = Ze(s, (D) => [Be, D, Be])), i.printComment && (!i.willPrintOwnComments || !i.willPrintOwnComments(t, e)) && (s = Nn(t, s, e)), s;
      }
      ...
      var Yn = /* @__PURE__ */ new Set(["JsonRoot", "ObjectExpression", "ArrayExpression", "StringLiteral", "NumericLiteral", "BooleanLiteral", "NullLiteral", "UnaryExpression", "TemplateLiteral"]), bo = /* @__PURE__ */ new Set(["OperationDefinition", "FragmentDefinition", "VariableDefinition", "TypeExtensionDefinition", "ObjectTypeDefinition", "FieldDefinition", "DirectiveDefinition", "EnumTypeDefinition", "EnumValueDefinition", "InputValueDefinition", "InputObjectTypeDefinition", "SchemaDefinition", "OperationTypeDefinition", "InterfaceTypeDefinition", "UnionTypeDefinition", "ScalarTypeDefinition"]);
      function Rn(t, e, r) {
        if (!e)
          return false;
        switch (t.parser) {
      ...
      function jn(t, e, r) {
        ...
        if (_o(e)) {
          ...
          ({ startNode: F, endNode: f } = Bo(D, c, e));
      ...
      function wo(t, e) {
        ...
        for (let a of An(t, { getVisitorKeys: u, filter: i }))
          s = a;
        return s;
      }
      var Vn = wo;
...
`, l);
      ...
      function Un(t, e) {
        ...
        return r = Jt(t, r, -1), n = Jt(t, n, 0), o = Jt(t, o, t.length), { ...e, cursorOffset: r, rangeStart: n, rangeEnd: o };
      }
      function Kn(t, e) {
...
`);
        ...
        return { hasBOM: i, text: t, options: Un(t, { ...e, cursorOffset: r, rangeStart: n, rangeEnd: o, endOfLine: u }) };
      }
      ...
      async function Jn(t, e) {
        let r = Sr(t), { formatted: n } = await Xt(r, { ...e, parser: "__js_expression" });
        return n;
      }
      ...
      var Ee = To;
      function So(t, e) {
        return e === false ? false : t.charAt(e) === "/" && t.charAt(e + 1) === "/" ? mt(t, e) : e;
      }
      var he = So;
      function vo(t, e) {
        let r = null, n = e;
      ...
      function Po(t, e) {
        let r = null, n = e;
        for (; n !== r; )
          r = n, n = Ft(t, n), n = Ee(t, n), n = N(t, n);
        return n = he(t, n), n = Y(t, n), n !== false && V(t, n);
      }
      var ht = Po;
      function Zt(t) {
        if (typeof t != "string")
...
`)
      ...
      var nu = jo;
      function Vo(t, e, r) {
        let n = e === '"' ? "'" : '"', u = ee(false, t, /\\(.)|(["'])/gs, (i, s, a) => s === n ? s : a === e ? "\\" + a : a || (r && /^[^\n\r"'0-7\\bfnrt-vx\u2028\u2029]$/.test(s) ? s : "\\" + s));
        return e + u + e;
      }
      var uu = Vo;
      function $o(t, e, r) {
      ...
      var Ko = { join: ke, line: Ke, softline: Er, hardline: G, literalline: He, group: xt, conditionalGroup: fr, fill: Ge, lineSuffix: _e, lineSuffixBoundary: Fr, cursor: Be, breakParent: le, ifBreak: pr, trim: mr, indent: ie, indentIfBreak: dr, align: oe, addAlignmentToDoc: qe, markAsRoot: cr, dedentToRoot: Dr, dedent: lr, hardlineWithoutBreakParent: Ae, literallineWithoutBreakParent: _t, label: hr, concat: (t) => t }, Ho = { printDocToString: fe }, qo = { willBreak: kr, traverseDoc: xe, findInDoc: Je, mapDoc: Ne, removeLines: wr, stripTrailingHardline: Xe, replaceEndOfLine: Or, canBreak: Nr };
      var ou = "3.0.3";
      function De(t, e = 1) {
        return async (...r) => {
      ...
      var Xo = De(et, 0), Zo = { parse: De(Hn), formatAST: De(qn), formatDoc: De(Jn), printToDoc: De(Xn), printDocToString: De(Zn) };
      return nr(Qo);
    });
  }
});
