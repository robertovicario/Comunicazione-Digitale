...
// node_modules/mermaid/dist/mindmap-definition-d3cb8e67.js
var Ki = function() {
...
var Op = (pe, fe) => {
  switch (A.debug("In get type", pe, fe), pe) {
    case "[":
      return yt.RECT;
    case "(":
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    var Rr = il, Sa = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof lh < "u" ? lh : typeof self < "u" ? self : {};
    function sl(t, e) {
    ...
    var ah = Lt({
      ...
      for (var m = true, b = 0; m && b < n.maxIterations; )
        m = false, lh2(s, a, o, u, n), fh(o, l, s, a, n), ih(o, l, n.sensitivityThreshold) || (m = true), b++;
      return i = hh2(a, o, n, r), {
        clusters: i,
      ...
      if (!(!t || t.length === 0)) {
        ...
        for (var E = function(w) {
          ...
          if (!C.hasUnbundled) {
            ...
            ii2(C.eles), F.forEach(function(Se) {
...
`), p = 0; p < y.length; p++) {
    ...
    var Xn2 = {};
    Xn2.registerCalculationListeners = function() {
    ...
    }, Xn2.onUpdateEleCalcs = function(t) {
      var e = this.onUpdateEleCalcsFns = this.onUpdateEleCalcsFns || [];
      e.push(t);
    }, Xn2.recalculateRenderedStyle = function(t, e) {
      var r = function(E) {
    ...
    var lu = {};
    [Vr, Hn, Vt, Qa, Fi, fr, su, Xn2, qn].forEach(function(t) {
      Ue(lu, t);
    });
    var fu = {};
    ...
    Dt.reasons = ba, Dt.getTextureQueue = function(t) {
      ...
      for (var r = this, a = r.getTextureQueue(t), n = r.getRetiredTextureQueue(t), i = 0; i < n.length; i++) {
        var s = n[i];
        if (s.width >= e)
          return s.retired = false, s.usedWidth = 0, s.invalidatedWidth = 0, s.fullnessChecks = 0, ii2(s.eleCaches), s.context.setTransform(1, 0, 0, 1, 0, 0), s.context.clearRect(0, 0, s.width, s.height), wr(n, s), a.push(s), s;
      }
    ...
    Ur2.instanceString = function() {
      return "stylesheet";
    }, Ur2.selector = function(t) {
      var e = this.length++;
      return this[e] = {
        selector: t,
        properties: []
      }, this;
    }, Ur2.css = function(t, e) {
      var r = this.length - 1;
      if (j(t))
      ...
      return this;
    }, Ur2.style = Ur2.css, Ur2.generateStyle = function(t) {
      var e = new Ft(t);
      return this.appendToStyle(e);
    }, Ur2.appendToStyle = function(t) {
      for (var e = 0; e < this.length; e++) {
...
function Qp(pe, fe) {
  fe.edges().map((ee, ce) => {
    ...
    if (ee[0]._private.bodyBounds) {
      ...
      A.trace("Edge: ", ce, H), pe.insert("path").attr(
        "d",
...
function jp(pe) {
  pe.nodes().map((fe, ee) => {
    ...
    A.info("Id:", ee, "Position: (", fe.position().x, ", ", fe.position().y, ")", ce), H.attr(
      "transform",
...
var ey = async (pe, fe, ee, ce) => {
  const H = Xn();
  H.htmlLabels = false, A.debug(`Rendering mindmap diagram
` + pe, ce.parser);
  const O = Xn().securityLevel;
  let T;
  O === "sandbox" && (T = Ct("#i" + fe));
  ...
  Qp(U, K), jp(K), __(void 0, S, H.mindmap.padding, H.mindmap.useMaxWidth);
};
var ty = {
  draw: ey
};
var ry = (pe) => {
  ...
  for (let ee = 0; ee < pe.THEME_COLOR_LIMIT; ee++)
    pe["lineColor" + ee] = pe["lineColor" + ee] || pe["cScaleInv" + ee], ci(pe["lineColor" + ee]) ? pe["lineColor" + ee] = B(pe["lineColor" + ee], 20) : pe["lineColor" + ee] = L(pe["lineColor" + ee], 20);
  for (let ee = 0; ee < pe.THEME_COLOR_LIMIT; ee++) {
    const ce = "" + (17 - 3 * ee);
    fe += `
...
mermaid/dist/mindmap-definition-d3cb8e67.js:
  (*!
...
*/
//# sourceMappingURL=mindmap-definition-d3cb8e67-SFHXYTZ6.js.map
