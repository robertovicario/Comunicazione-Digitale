import {
  ...
  we,
  ye
} from "./chunk-IHVJ5UAK.js";
import "./chunk-2MQPPUKX.js";
import {
  Ye,
  ze
} from "./chunk-XXVO7FYO.js";
import "./chunk-MXFTCTPC.js";
import "./chunk-2NDHMHHW.js";
import {
  D,
  L,
  Un,
...
// node_modules/mermaid/dist/flowDiagram-bc4d5112.js
function Dt(r) {
  if (!r.ok)
...
var bt = function(r, e, t, n, a, s) {
  ...
  Object.keys(r).forEach(function(d) {
    ...
    A.warn("Adding node", l.id, l.domId), e.setNode(s.db.lookUpDomId(l.id), {
      labelType: "svg",
...
var kt = function(r, e, t) {
  ...
  r.forEach(function(i) {
    ...
    l.style = v, l.labelStyle = h, i.interpolate !== void 0 ? l.curve = _0(i.interpolate, Df) : r.defaultInterpolate !== void 0 ? l.curve = _0(r.defaultInterpolate, Df) : l.curve = _0(mt.curve, Df), i.text === void 0 ? i.style !== void 0 && (l.arrowheadStyle = "fill: #333") : (l.arrowheadStyle = "fill: #333", l.labelpos = "c", ka(Xn().flowchart.htmlLabels) ? (l.labelType = "html", l.label = `<span id="L-${o}" class="edgeLabel L-${c2}' L-${d}" style="${l.labelStyle}">${i.text.replace(
      /fa[blrs]?:fa-[\w-]+/g,
...
var xe = function(r, e) {
  return A.info("Extracting classes"), e.db.getClasses();
};
var me = function(r, e, t, n) {
  A.info("Drawing flowchart");
  const { securityLevel: a, flowchart: s } = Xn();
  let i;
  a === "sandbox" && (i = Ct("#i" + e));
  ...
  const k = new de();
  ge.addToRender(k), k.arrows().none = function(b2, L2, x, B) {
  ...
  for (k(E, h), E.selectAll("g.node").attr("title", function() {
    ...
    if (u = p[y], u.title !== "undefined") {
      ...
      ), L2 = w[0].x.baseVal.value, x = w[0].y.baseVal.value, B = w[0].width.baseVal.value, C = Ct(b2[0]).select(".label");
      C.attr("transform", `translate(${L2 + B / 2}, ${x + 14})`), C.attr("id", e + "Text");
  ...
  if (!s.htmlLabels) {
    ...
    for (const b2 of w) {
      const L2 = b2.getBBox(), x = c2.createElementNS("http://www.w3.org/2000/svg", "rect");
      x.setAttribute("rx", 0), x.setAttribute("ry", 0), x.setAttribute("width", L2.width), x.setAttribute("height", L2.height), b2.insertBefore(x, b2.firstChild);
    }
  }
  __(h, I, s.diagramPadding, s.useMaxWidth), Object.keys(g).forEach(function(w) {
    const b2 = g[w];
    if (b2.link) {
...
//# sourceMappingURL=flowDiagram-bc4d5112-LAFKHGC7.js.map
