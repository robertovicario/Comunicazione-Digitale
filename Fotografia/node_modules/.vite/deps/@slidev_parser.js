...
// node_modules/@slidev/parser/dist/chunk-7UHTFYFF.mjs
...
}, _head = new WeakMap(), _tail = new WeakMap(), _size = new WeakMap(), _a);
...
function resolveConfig(headmatter, themeMeta = {}, filepath, verify = false) {
  ...
  const config = {
    ...
    ...headmatter,
    fonts: resolveFonts({
      ...(_a2 = themeMeta.defaults) == null ? void 0 : _a2.fonts,
...
function resolveDrawings(options = {}, filepath) {
  ...
  const persistPath = typeof persist === "string" ? persist : persist ? `.slidev/drawings${filepath ? `/${(_a2 = filepath.match(/([^\\\/]+?)(\.\w+)?$/)) == null ? void 0 : _a2[1]}` : ""}` : false;
  return {
    enabled,
    persist: persistPath,
    presenterOnly,
...
function filterDisabled(data) {
  data.slides = data.slides.filter((i) => {
    var _a2;
    return !((_a2 = i.frontmatter) == null ? void 0 : _a2.disabled);
  });
  return data;
}
...
function parseSlide(raw) {
  ...
  if (frontmatter.title || frontmatter.name) {
    ...
    title = (_a2 = match == null ? void 0 : match[2]) == null ? void 0 : _a2.trim();
...
async function parse(markdown, filepath, themeMeta, extensions, onHeadmatter) {
  ...
  {
    let hm = "";
    if (lines[0].match(/^---([^-].*)?$/) && !((_a2 = lines[1]) == null ? void 0 : _a2.match(/^\s*$/))) {
      let hEnd = 1;
