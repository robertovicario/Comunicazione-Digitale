...
// node_modules/mermaid/dist/gitGraphDiagram-d1708452.js
var mt = function() {
...
mt.parser = mt;
var Vt = mt;
var at = Xn().gitGraph.mainBranchName;
var Dt = Xn().gitGraph.mainBranchOrder;
var R = {};
var S = null;
var Z = {};
...
var xt = {};
var qt = function(r) {
  A.debug("options str", r), r = r && r.trim(), r = r || "{}";
  try {
    xt = JSON.parse(r);
  } catch (a) {
    A.error("error while parsing gitGraph options", a.message);
  }
};
var Yt = function() {
  return xt;
};
var Kt = function(r, a, o, u) {
  A.debug("Entering commit:", r, a, o, u), a = In.sanitizeText(a, Xn()), r = In.sanitizeText(r, Xn()), u = In.sanitizeText(u, Xn());
  const n = {
    id: a || U + "-" + ut(),
    message: r,
    seq: U++,
  ...
  S = n, R[n.id] = n, L[v] = n.id, A.debug("in pushCommit " + n.id);
};
var Ft = function(r, a) {
  if (r = In.sanitizeText(r, Xn()), L[r] === void 0)
    L[r] = S != null ? S.id : null, Z[r] = { name: r, order: a ? parseInt(a, 10) : null }, yt(r), A.debug("in createBranch");
  else {
    let o = new Error(
...
var Ut = function(r, a, o, u) {
  r = In.sanitizeText(r, Xn()), a = In.sanitizeText(a, Xn());
  ...
  S = m, R[m.id] = m, L[v] = m.id, A.debug(L), A.debug("in mergeBranch");
};
var Wt = function(r, a, o) {
  if (A.debug("Entering cherryPick:", r, a, o), r = In.sanitizeText(r, Xn()), a = In.sanitizeText(a, Xn()), o = In.sanitizeText(o, Xn()), !r || R[r] === void 0) {
    let c = new Error(
  ...
  if (!a || R[a] === void 0) {
    ...
    S = m, R[m.id] = m, L[v] = m.id, A.debug(L), A.debug("in cherryPick");
  }
};
var yt = function(r) {
  if (r = In.sanitizeText(r, Xn()), L[r] === void 0) {
...
function _t(r) {
  ...
  for (let n in L)
    L[n] === a.id && u.push(n);
  if (A.debug(u.join(" ")), a.parents && a.parents.length == 2) {
...
var Jt = function() {
  R = {}, S = null;
  let r = Xn().gitGraph.mainBranchName, a = Xn().gitGraph.mainBranchOrder;
  L = {}, L[r] = null, Z = {}, Z[r] = { name: r, order: a }, v = r, U = 0, T_();
};
var Qt = function() {
...
var dt = (r, a, o) => {
  const u = Xn().gitGraph, n = r.append("g").attr("class", "commit-bullets"), c = r.append("g").attr("class", "commit-labels");
  let m = 0;
...
var ae = (r, a, o) => Object.keys(o).filter((c) => o[c].branch === a.branch && o[c].seq > r.seq && o[c].seq < a.seq).length > 0;
var Q = (r, a, o = 0) => {
...
var oe = (r, a) => {
  const o = Xn().gitGraph, u = r.append("g");
  a.forEach((n, c) => {
...
var le = function(r, a, o, u) {
  se();
  const n = Xn(), c = n.gitGraph;
  A.debug("in gitgraph renderer", r + `
`, "id:", a, o), J = u.db.getCommits();
  ...
  }), dt(l, J, false), c.showBranches && oe(l, m), ce(l, J), dt(l, J, true), Ke.insertTitle(
    l,
    "gitTitleText",
    c.titleTopMargin,
...
//# sourceMappingURL=gitGraphDiagram-d1708452-RRO53ESE.js.map
