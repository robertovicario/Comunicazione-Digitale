...
// node_modules/mermaid/dist/styles-c6a4642b.js
var gt = function() {
  var t = function(C, r, n, i) {
    ...
    performAction: function(r, n, i, o, p, e, B) {
      ...
      switch (p) {
        ...
        case 18:
          ...
          break;
        case 19:
          var A2 = e[l], O = e[l - 2].trim();
          if (e[l].match(":")) {
            var st = e[l].split(":");
            A2 = st[0], O = [O, st[1]];
          }
          this.$ = { stmt: "state", id: A2, type: "default", description: O };
          break;
        case 20:
    ...
    parse: function(r) {
      var n = this, i = [0], o = [], p = [null], e = [], B = this.table, l = "", A2 = 0, O = 0, st = 2, $ = 1, ft = e.slice.call(arguments, 1), S = Object.create(this.lexer), L = { yy: {} };
      ...
      for (var _, v, m, pt, N = {}, it, b, Ct, rt; ; ) {
        if (v = i[i.length - 1], this.defaultActions[v] ? m = this.defaultActions[v] : ((_ === null || typeof _ > "u") && (_ = jt()), m = B[v] && B[v][_]), typeof m > "u" || !m.length || !m[0]) {
          ...
          S.showPosition ? St = "Parse error on line " + (A2 + 1) + `:
` + S.showPosition() + `
Expecting ` + rt.join(", ") + ", got '" + (this.terminals_[_] || _) + "'" : St = "Parse error on line " + (A2 + 1) + ": Unexpected " + (_ == $ ? "end of input" : "'" + (this.terminals_[_] || _) + "'"), this.parseError(St, {
            text: S.match,
        ...
        switch (m[0]) {
          case 1:
            i.push(_), p.push(S.yytext), e.push(S.yylloc), i.push(m[1]), _ = null, O = S.yyleng, l = S.yytext, A2 = S.yylineno, yt = S.yylloc;
            break;
          case 2:
...
var ne = (t) => {
  A.info("Setting root doc", t), lt = t;
};
var ae = () => lt;
var at = (t, s, a) => {
  if (s.stmt === It)
...
var ce = (t) => {
  let s;
  t.doc ? s = t.doc : s = t, A.info(s), Pt(true), A.info("Extract", s), s.forEach((a) => {
    switch (a.stmt) {
      case _t:
        I(
          a.id.trim(),
...
var I = function(t, s = Et, a = null, h = null, f = null, d = null, y = null, k = null) {
  ...
  g.states[u] === void 0 ? (A.info("Adding state ", u, h), g.states[u] = {
    id: u,
    descriptions: [],
    type: s,
    doc: a,
    ...
    styles: [],
    textStyles: []
  }) : (g.states[u].doc || (g.states[u].doc = a), g.states[u].type || (g.states[u].type = s)), h && (A.info("Setting state description", u, h), typeof h == "string" && kt(u, h.trim()), typeof h == "object" && h.forEach((E) => kt(u, E.trim()))), f && (g.states[u].note = f, g.states[u].note.text = In.sanitizeText(
    g.states[u].note.text,
    Xn()
  )), d && (A.info("Setting state classes", u, d), (typeof d == "string" ? [d] : d).forEach((T) => xt(u, T.trim()))), y && (A.info("Setting state styles", u, y), (typeof y == "string" ? [y] : y).forEach((T) => _e(u, T.trim()))), k && (A.info("Setting state styles", u, y), (typeof k == "string" ? [k] : k).forEach((T) => me(u, T.trim())));
};
var Pt = function(t) {
  ct = {
    root: $t()
  }, g = ct.root, F = 0, P = wt(), t || T_();
};
var V = function(t) {
  return g.states[t];
};
...
function ye(t, s, a) {
  ...
  I(
    ...
    id1: h,
    id2: d,
    relationTitle: In.sanitizeText(a, Xn())
  });
}
var Ft = function(t, s, a) {
  if (typeof t == "object")
    ...
    I(h, f), I(d, y), g.relations.push({
      id1: h,
      id2: d,
      title: In.sanitizeText(a, Xn())
    });
  }
};
var kt = function(t, s) {
  const a = g.states[t], h = s.startsWith(":") ? s.replace(":", "").trim() : s;
  a.descriptions.push(In.sanitizeText(h, Xn()));
};
var pe = function(t) {
...
//# sourceMappingURL=chunk-XA3DNIAY.js.map
